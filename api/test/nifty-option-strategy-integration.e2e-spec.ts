...
describe('NIFTY Option Strategy Integration (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    niftyOptionService = moduleFixture.get<NiftyOptionSellingService>(
  ...
  describe('Complete Strategy Implementation Testing', () => {
    ...
    it('should handle bullish entry conditions (Bull Put Spread)', async () => {
      ...
      const strikes = (niftyOptionService as any).selectStrikes(
        spotPrice,
        strategy,
        'BULL_PUT_SPREAD',
      );
    ...
    it('should handle exit conditions correctly', async () => {
      ...
      const daysToExpiry =
        niftyOptionService.calculateDaysToExpiry(futureExpiry);
    ...
    it('should handle strike price generation', () => {
      ...
      const strikes = (niftyOptionService as any).generateStrikePrices(
        spotPrice,
      );
    ...
    it('should handle spread order generation', () => {
      ...
      const spreadOrder = (niftyOptionService as any).createSpreadOrder(
        strikes,
        'BULL_PUT_SPREAD',
        strategy,
      );
    ...
    it('should handle error scenarios gracefully', async () => {
      ...
      const result = await niftyOptionService.evaluateStrategy(
        strategy,
        invalidContext,
      );
      ...
      const incompleteResult = await niftyOptionService.evaluateStrategy(
        strategy,
        incompleteContext,
      );
