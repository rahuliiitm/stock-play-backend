...
async function analyzeEMACrossoverFrequency() {
  console.log('🔍 ANALYZING EMA CROSSOVER FREQUENCY - WHY SO FEW TRADES?\n');
  ...
  console.log(`📊 Analyzing EMA crossovers from ${startDate.toLocaleDateString()} to ${endDate.toLocaleDateString()}\n`);
  ...
  console.log('🔍 ANALYZING EACH CANDLE FOR CROSSOVER CONDITIONS...\n');
  ...
  console.log('\n📊 EMA CROSSOVER ANALYSIS RESULTS:');
  console.log('=====================================\n');
  ...
  console.log(`❌ EMA CROSSOVER RATE: ${crossoverRate.toFixed(3)}% - TOO LOW!`);
  console.log(`❌ RSI Long Rate: ${rsiLongRate.toFixed(3)}%`);
  console.log(`❌ RSI Short Rate: ${rsiShortRate.toFixed(3)}%`);
  console.log(`❌ Combined Rate: ${allConditionsRate.toFixed(3)}% - EXTREMELY LOW!\n`);
...
analyzeEMACrossoverFrequency().catch(console.error);
