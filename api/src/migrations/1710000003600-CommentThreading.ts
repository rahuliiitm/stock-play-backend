...
export class CommentThreading1710000003600 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE portfolio_comments DROP CONSTRAINT IF EXISTS fk_comment_parent`)
    await queryRunner.query(`ALTER TABLE portfolio_comments DROP COLUMN IF EXISTS parent_id`)
    await queryRunner.query(`ALTER TABLE portfolio_comments DROP COLUMN IF EXISTS root_id`)
    await queryRunner.query(`ALTER TABLE portfolio_comments DROP COLUMN IF EXISTS depth`)
  }
} 