...
async function runOptimizedBacktestDirect() {
  ...
  const optimizedConfig = {
    ...
    strategyConfig: {
      ...
      rsiPeriod: 14,
      rsiEntryLong: 50,                  // RSI 50 filter for long entries (above 50)
      rsiEntryShort: 50,                // RSI 50 filter for short entries (below 50)
  ...
  maxTrailDistance: 0.05,            // Maximum 5% trailing distance (prevent extreme trailing)
      ...
      maxLossPct: 0.05,
      positionSize: 1,
      maxLots: 15, // MINIMAL: High max lots for maximum trades (safety limit)
