console.log('🔍 SIMPLE EMA CROSSOVER ANALYSIS');
console.log('=================================\n');

console.log('🚨 PROBLEM IDENTIFIED: EMA CROSSOVER DETECTION LOGIC\n');

console.log('📊 CURRENT EMA CROSSOVER LOGIC:');
console.log('   📈 crossedUp = fastPrev <= slowPrev && fast > slow');
console.log('   📉 crossedDown = fastPrev >= slowPrev && fast < slow\n');
